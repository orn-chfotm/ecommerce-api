...
import com.build.ecommerce.adminapi.security.login.CustomAdminLoginFilter;
...
public class SecurityFilterConfig {
    ...
    SecurityFilterChain http(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeHttpRequests(auth -> {
                    auth
                            .requestMatchers(HttpMethod.POST, "/v1/admin", "/v1/login/admin", "/client").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:3101"));
